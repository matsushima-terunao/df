/*
 * $Id: Java3DWorld.cpp,v 1.37 2008/03/12 16:30:47 matsushima Exp $
 */
 ...
 * @version $Id: Java3DWorld.cpp,v 1.37 2008/03/12 16:30:47 matsushima Exp $
 * 
 * $Log: Java3DWorld.cpp,v $
 * Revision 1.37  2008/03/12 16:30:47  matsushima
 * Doxygen 対応
 *
 * Revision 1.36  2008/03/11 16:20:59  matsushima
...
/*C*/
#ifdef _IS_H_
class Java3DWorld : public Java3D
{
/**/
/*J*
    // Parameters
...
/**/
        ...
        Log::out("render    :" + *render->render_time);
        Log::out("clear     :" + *render->clear_time);
        Log::out("repaint   :" + *render->repaint_time);
        Log::out("paint     :" + *render->paint_time);
