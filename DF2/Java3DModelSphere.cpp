/*
 * $Id: Java3DModelSphere.cpp,v 1.29 2008/03/12 16:30:47 matsushima Exp $
 */
 ...
 * @version $Id: Java3DModelSphere.cpp,v 1.29 2008/03/12 16:30:47 matsushima Exp $
 * 
 * $Log: Java3DModelSphere.cpp,v $
 * Revision 1.29  2008/03/12 16:30:47  matsushima
 * Doxygen 対応
 *
 * Revision 1.28  2008/03/06 16:42:45  matsushima
 * JavaDoc/Doxygen 対応
 *
...
/*C*/
#ifdef _IS_H_
class Java3DModelSphere : public virtual Java3DModel
{
/**/
/*J*
...
//Log.out("> p = " + p);
        ...
        _R(model).setTexture(new JavaRenderTexture(texture, 1 << unit, 1 << unit, texture_xs, texture_ys));
    }
/*C*/
#endif
/**/
...
#else
    int Java3DModelSphere::get_div_a(int b, int div_a0, int div_da) {
/**/
...
private:
    static int get_vert_color(int width, double a, double r, int surfaces,
        int* verts, int* vert_colors, int* texture_xs, int* texture_ys, int p);
#else
    int Java3DModelSphere::get_vert_color(int width, double a, double r, int surfaces,
        int* verts, int* vert_colors, int* texture_xs, int* texture_ys, int p) {
/**/
        double ra = 1.0;
        if (2 == surfaces)
