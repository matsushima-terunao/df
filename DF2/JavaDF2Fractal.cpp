/*
 * $Id: JavaDF2Fractal.cpp,v 1.16 2008/03/12 16:30:47 matsushima Exp $
 */
 ...
 * @version $Id: JavaDF2Fractal.cpp,v 1.16 2008/03/12 16:30:47 matsushima Exp $
 * 
 * $Log: JavaDF2Fractal.cpp,v $
 * Revision 1.16  2008/03/12 16:30:47  matsushima
 * Doxygen 対応
 *
 * Revision 1.15  2008/03/06 16:42:45  matsushima
 * JavaDoc/Doxygen 対応
 *
...
#else
    int* JavaDF2Fractal::create(int m, double h, int max) {
/**/
...
#else
    double JavaDF2Fractal::gauss(Random& random, int n_rand, double gauss_add, double gauss_fac) {
/**/
        double sum = 0;
        int i;
        for (i = 0; i < n_rand; ++ i)
...
#else
    void JavaDF2Fractal::fft1(double* buf1_real, double* buf1_imag, double* tmp1_real, double* tmp1_imag, int n, int m) {
/**/
        int i, j, x, y;
...
#else
    void JavaDF2Fractal::fft2(double* buf_real, double* buf_imag, double* tmp_real, double* tmp_imag, int n, int m) {
/**/
