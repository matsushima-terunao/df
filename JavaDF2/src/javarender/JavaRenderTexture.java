/*
 * $Id: JavaRenderTexture.java,v 1.11 2008/03/06 16:44:00 matsushima Exp $
 */
 ...
 * @version $Id: JavaRenderTexture.java,v 1.11 2008/03/06 16:44:00 matsushima Exp $
 * 
 * $Log: JavaRenderTexture.java,v $
...
/*C*
#ifdef _IS_H_
class JavaRenderTexture : public JBase<JavaRenderTexture>
{
/**/
/*J*/
    // Text texture
...
#ifdef _IS_H_
public:
    JavaRenderTexture(Component* component, int font_w, int font_h, Image* _font_image);
#else
    JavaRenderTexture::JavaRenderTexture(Component* component, int font_w, int font_h, Image* _font_image) {
#define this (*this)
        JPARAM(Image, font_image);
        JSTATIC(Thread);
        JSTATIC(Log);
/**/
        this.ptx = null;
