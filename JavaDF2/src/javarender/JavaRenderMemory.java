/*
 * $Id: JavaRenderMemory.java,v 1.15 2008/03/06 16:44:00 matsushima Exp $
 */
 ...
 * @version $Id: JavaRenderMemory.java,v 1.15 2008/03/06 16:44:00 matsushima Exp $
 * 
 * $Log: JavaRenderMemory.java,v $
 * Revision 1.15  2008/03/06 16:44:00  matsushima
 * JavaDoc/Doxygen 対応
 *
...
/*C*
#ifdef _IS_H_
class JavaRenderMemory : public JBase<JavaRenderMemory>, public JavaRenderAbstract
{
/**/
/*J*/
    // Off screen buffer
...
public:
    ...
    void JavaRenderMemory::fillPolygonGouraud(int* px, int* py, int* pc, JavaRenderTexture* texture, int* ptx, int* pty, int cnt) {
        JMEMBER(FillPolygon, fill_gouraud);
/**/
...
public:
    ...
    void JavaRenderMemory::fillPolygonGouraudAlpha(int* px, int* py, int* pc, JavaRenderTexture* texture, int* ptx, int* pty, int cnt) {
        JMEMBER(FillPolygon, fill_gouraud_alpha);
/**/
...
#ifdef _IS_H_
private:
    Rectangle draw_string(int color, int x, int y, int unit16, String string, boolean proportional, JavaRenderTexture* _render_font, boolean calc);
#else
    Rectangle JavaRenderMemory::draw_string(int color, int x, int y, int unit16, String string, boolean proportional, JavaRenderTexture* _render_font, boolean calc) {
        JPARAM(JavaRenderTexture, render_font);
/**/
