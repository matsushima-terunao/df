/*
 * $Id: Perf.java,v 1.12 2008/03/06 16:44:00 matsushima Exp $
 */
 ...
 * @version $Id: Perf.java,v 1.12 2008/03/06 16:44:00 matsushima Exp $
 * 
 * $Log: Perf.java,v $
...
/**/
        return
            format((0 == count) ? "-" : String(time / count), 8) +
...
class Perf : public JBase<Perf>, public PerfStatic
{
public:
...
/*C*
        ...
        String result = format(String(pc_time2 / 1000000), 8) + ";";
