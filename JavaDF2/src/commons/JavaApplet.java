/*
 * $Id: JavaApplet.java,v 1.14 2008/03/11 16:24:17 matsushima Exp $
 */
 ...
 * @version $Id: JavaApplet.java,v 1.14 2008/03/11 16:24:17 matsushima Exp $
 * 
 * $Log: JavaApplet.java,v $
...
/*C*
#ifdef _IS_H_
class JavaApplet : public JBase<JavaApplet>, public Applet,
...
/*J*/
    ...
    public long rest_time, skip_cnt, wait_cnt;
/*C*
protected:
    Thread* thread;
    Image* imageOff;
...
public:
    Perf* run_time;
    Perf* run_each_time;
    long rest_time, skip_cnt, wait_cnt;
/**/
...
Log.out("-> JavaApplet.destroy()");
        ...
        Log.out("run       :" + run_time);
        Log.out("run_each  :" + run_each_time);
Log.out("<- JavaApplet.destroy()");
    }
...
#ifdef _IS_H_
public:
    virtual void mouse_common(MouseEvent* _e, boolean value);
#else
    void JavaApplet::mouse_common(MouseEvent* _e, boolean value) {
        JPARAM(MouseEvent, e);
        JSTATIC(MouseEvent);
/**/
        //キーボードフォーカスe.consume();
...
#ifdef _IS_H_
public:
    virtual void mouseDragged(MouseEvent* _e);
#else
    void JavaApplet::mouseDragged(MouseEvent* _e) {
        JPARAM(MouseEvent, e);
/**/
        e.consume();
        mouseX = e.getX();
...
#ifdef _IS_H_
public:
    virtual void mouseMoved(MouseEvent* _e);
#else
    void JavaApplet::mouseMoved(MouseEvent* _e) {
        JPARAM(MouseEvent, e);
/**/
        e.consume();
        mouseX = e.getX();
